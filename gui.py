...
def newinput():  # Function will print a little instruction and
    # then get the input for the operator and the two numbers.
    ...
    newinput()
    # repeat the function after the last input or in case of an error
